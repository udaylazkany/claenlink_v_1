...
return new class extends Migration
{
    ...
    {
        Schema::create('price_for_residential_buildings', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedInteger('price_company_category'); 
    ...
    {
        Schema::dropIfExists('price_for_residential_buildings');
    }
};
